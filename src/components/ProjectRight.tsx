...
export const ProjectRight = ({color,title,description,image}: any) => {
    return (
        <div className="flex flex-col lg:flex-row items-center pt-10 md:pt-20 lg:py-20">
            ...
            <div className="w-full lg:w-6/12 h-auto md:h-auto flex items-center justify-center py-16" style={{backgroundColor: color}}>
                <div className='bg-white shadow-lg w-[50%] h-[80%] max-w-[500px]'>
