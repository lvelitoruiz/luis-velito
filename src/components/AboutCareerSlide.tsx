...
export const AboutCareerSlide = ({title,subtitle,description}: any) => {
    return (
        <div className="min-w-[90%] md:min-w-[45%] lg:min-w-[30%] flex flex-col">
            ...
            <p className="mt-[10px] text-[#e1554b] text-[30px] font-semibold">{title}</p>
            <p className="text-[#1C1B20] italic">{subtitle}</p>
            <p className="leading-[30px] text-[#606060] mt-[25px] description-lead" dangerouslySetInnerHTML={{ __html:description }}></p>
        </div>
    )
}
